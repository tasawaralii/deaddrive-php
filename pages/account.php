      ...
      <form method="POST">
            ...
            <div class="col-sm-5 col-md-6">
              <div class="form-outline mb-4">
                <input type="text" id="user_name" class="form-control"
                  value="<?PHP echo $user['first_name'] . " " . $user['last_name'] ?>" disabled />
        ...
        <div class="container-sm">
          <div class="row">
            ...
            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
              <div class="form-outline mb-4">
                <input type="text" id="user_role" class="form-control" value="<?PHP echo $user['role'] ?>" disabled />
        ...
        <div class="container-sm">
          <div class="text-center "><?PHP echo ($user['password'] != '') ? 'Change Password' : 'Set Password'; ?>
          </div>
          ...
          <div class="row">
            <div class="col-sm-5 col-md-6">
              <div class="form-outline mb-4">
                <input type="password" class="form-control" name="password" minlength="8" autocomplete="off"
                  id="new_password" oninput="validatePassword()" />
                <label class="form-label">New Password</label>
              </div>
            </div>
            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
              <div class="form-outline mb-4">
                <input id="retype_password" type="password" class="form-control" minlength="8" name="re_password"
        ...
        <div class="container-sm">
          ...
          <div class="row">
            <div class="col-sm-5 col-md-6">
              <div class="form-outline mb-4">
                <input type="text" class="form-control" name="site_tag" placeholder="DeadDrive"
            ...
            <div class="col-sm-5 offset-sm-2 col-md-6 offset-md-0">
              <div class="form-outline mb-4">
                <input type="text" class="form-control" name="site_url" placeholder="<?= $_ENV['NAME'] ?>"
                  value="<?= $user['site_url'] ?>" />
