...
class StaticClass {
    ...
    public static function DefaultApis($server_id,$parameter = "api") {
        ...
        switch($server_id) {
            ...
            case 11:
                if($parameter == "api")
                    return GDTOT_DEFAULT_API['api'];
                else if($parameter == "email")
                    return GDTOT_DEFAULT_API['gmail'];
            case 14:
            ...
            case 17:
                if($parameter == "api")
                    return NEODRIVE_DEFAULT_API;
                else if($parameter == "email")
                    return NEODRIVE_DEFAULT_EMAIL;
            default :
                return null;
        }
    }
